...
export var Field = function (props) {
    ...
    var onNativeComponentChange = React.useCallback(function (event) { return form.onChange(name, event.target.value); }, [name, formId]);
    ...
    return React.createElement(component, __assign({ 
        ...
        valid: !(Boolean(form.errors[name]) && form.touched[name]), children: children }, others));
};
