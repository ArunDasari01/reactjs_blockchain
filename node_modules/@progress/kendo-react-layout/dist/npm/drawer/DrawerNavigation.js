...
exports.DrawerNavigation = React.forwardRef(function (props, target) {
    ...
    var _a = React.useContext(DrawerContext_1.DrawerContext), animation = _a.animation, expanded = _a.expanded, mode = _a.mode, position = _a.position, onOverlayClick = _a.onOverlayClick, mini = _a.mini, dir = _a.dir, width = _a.width, miniWidth = _a.miniWidth, items = _a.items, onSelect = _a.onSelect;
    ...
    var navigationClassNames = React.useMemo(function () { return 'k-widget k-drawer ' + kendo_react_common_1.classNames({
    ...
    var drawerItems = (items && (React.createElement("ul", { className: 'k-drawer-items' }, items
        ...
        return (React.createElement(DrawerItem_1.DrawerItem, __assign({ onSelect: onSelect, index: index, key: index }, item)));
    }))));
...
exports.DrawerNavigation.propTypes = {
    children: PropTypes.any,
    className: PropTypes.string,
    style: PropTypes.object,
    tabIndex: PropTypes.number
};
exports.DrawerNavigation.displayName = 'KendoDrawerNavigation';
